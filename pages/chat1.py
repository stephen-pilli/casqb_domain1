...
if st.button('Start Chat', key='strtcht'):
    chatbot1 = st.session_state.chatStatus
    expcode = str(st.session_state.expcode).split('_')[1].split('&')[chatbot1].replace("$", "_") ##<<<<<<******************************** very important make deligent changes in the chatbot2 and chatbot3 files. 
