...
st.session_state.choice_problem = st.session_state.chat3[-3]['content']
...
if st.session_state.match_c and st.session_state.match_d:
    ...
    st.session_state.alternatives_list = [st.session_state.extracted_text_d, st.session_state.extracted_text_c]
...
# # Attention Check 
# st.session_state.attention_check = st.radio("Manual Test: Select 7 on the scale", scale)
# Temporal Demand
...
if st.button("Submit"):
    ...
    # st.session_state.ac3 = scale_to_numeric(st.session_state.attention_check) == 7
    st.session_state.ac3 = st.session_state.attention_check == st.session_state.extracted_text_d

    
    # st.write("### Your NASA-TLX Scores:")
    st.session_state.ntlx3 = results
    switch_page("zfinish")
