...
if st.button('Start Chat'):
    chatbot3 = st.session_state.chatStatus
    expcode = str(st.session_state.expcode).split('_')[1].split('&')[chatbot3].replace("$", "_") ##<<<<<<******************************** very important make deligent changes in the chatbot2 and chatbot3 files. 
...
def finishAndProceed():
    st.session_state.chat3 = st.session_state['messages']
