...
st.session_state.choice_problem = st.session_state.chat1[-3]['content']
...
if st.button("Submit"):
    ...
    st.session_state.ac1 = st.session_state.attention_check == st.session_state.extracted_text_d
